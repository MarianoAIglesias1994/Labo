...
;%%%%%%%%%% Se va a realizar la lectura del registro configurado para ver si efectivamente se escribió
	...
	LDI R25,  0b00101101	;Dirección del registro a leer ;THRESH_INACT 0x25 0b0010010
	LDI R26, 0b00001000	;Dato a transmitir ;THRESH_INACT  8 bit unsigned no dejar en 0x00 umbral de inactividad (62.5 mg/LSB) 
...
CHECK_TWI_ST_REG:
	LDS R21,TWSR			;Check value of TWI status register. Mask prescaler bits. If
	ANDI R21, 0xF8		;status different from START go to ERROR
	CP R21, R17
	BRNE ERROR
	RJMP NO_ERROR
ERROR:
